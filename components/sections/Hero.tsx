  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-6 md:px-12 bg-(--bg-primary)">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        {/* Eyebrow */}
        <div className="inline-flex items-center gap-3 px-5 py-2 mb-8 rounded-full border border-(--border-strong) bg-(--surface)/80">
        ...
        {/* Title */}
        <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-bold leading-[0.85] tracking-tighter text-white mb-6">
          {t("title")}
        </h1>

        {/* Subtitle (italic, statique, en gradient violet) */}
        <p
        ...
        {/* Description */}
        <p className="text-base md:text-xl text-white/50 max-w-2xl mx-auto mb-14 leading-relaxed font-medium">
          {t("sub")}
        </p>
