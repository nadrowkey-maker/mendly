// @ts-nocheck — third-party 21st.dev component; CDN dynamic import has no type declarations
"use client";
...
const TubesCursor = ({
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // Patch HTMLCanvasElement.prototype.getContext to inject alpha:true so THREE.js
      // creates a transparent WebGL canvas instead of an opaque black one.
      ...
      HTMLCanvasElement.prototype.getContext = function (type, attrs) {
        ...
        if (ctx && (type === "webgl" || type === "webgl2")) {
          ...
          ctx.clearColor = (r, g, b) => origClearColor(r, g, b, 0);
        }
        return ctx;
      };
